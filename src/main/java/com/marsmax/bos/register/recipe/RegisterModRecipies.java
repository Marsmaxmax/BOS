...
public class RegisterModRecipies {
    ...
    public static final RegistryObject<RecipeSerializer<ArcFurnanceRecipe>> ARC_BLASTING = SERIALIZERS.register("arc_blasting", () -> ArcFurnanceRecipe.Serializer.INSTANCE);
