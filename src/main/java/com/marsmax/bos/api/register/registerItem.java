...
public class registerItem {
    ...
    public static final RegistryObject<Item> ELEVATOR_CHIP = ITEMS.register("elevator_chip", () -> new Item(new Item.Properties().tab(CreativeTab.BOS)));

    public static final RegistryObject<Item> STATION_CHIP = ITEMS.register("station_chip", () -> new Item(new Item.Properties().tab(CreativeTab.BOS)));

    public static final RegistryObject<Item> ASTEROID_CHIP = ITEMS.register("asteroid_chip", () -> new Item(new Item.Properties().tab(CreativeTab.BOS)));
