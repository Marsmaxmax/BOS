...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> BAUXITE_ORE_OVERWORLD_KEY = registerKey("bauxite_ore_overworld");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldBauxiteOres = List.of(
                OreConfiguration.target(dirtReplaceables,RegisterBlock.BAUXIT_ORE.get().defaultBlockState()));
        ...
        register(context, BAUXITE_ORE_OVERWORLD_KEY, Feature.ORE, new OreConfiguration(overworldBauxiteOres, 9));
